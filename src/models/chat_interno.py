...
class GrupoChat(db.Model):
    ...
    criado_por = db.Column(db.Integer, db.ForeignKey('funcionaria.id'), nullable=False)
...
class MensagemChat(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    grupo_id = db.Column(db.Integer, db.ForeignKey('grupos_chat.id'), nullable=False)
    remetente_id = db.Column(db.Integer, db.ForeignKey('funcionaria.id'), nullable=False)
